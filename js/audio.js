/**
 * @file audio.js
 * @description Web Audio API sound synthesis engine for GEO Ride, generating dynamic engine pitch, tire skid noise filters, and launch control sounds.
 */
...
/**
 * Creates noise buffer for procedural tire friction sound synthesis.
...
export function updateAudio(state) {
    ...
    if (state.activeVehicle === 'truck') {
        ...
        baseFreq = 150;
        volMult = 0.15; // Barely perceptible whisper
