        ...
        const handleActivation = async () => {
            ...
            try {
                ...
                if (res && res.is_pro) {
                    ...
                    showToast('NO ACTIVE PLAN', 'No active subscription found for this email. Check your receipt or choose a plan below.');
                }
            } catch (err) {
...
export function updateToggleStates() {
    ...
    if (vehicleGodBtn) {
        ...
        const badge = typeof vehicleGodBtn.querySelector === 'function' ? vehicleGodBtn.querySelector('.pro-badge-pill') : null;
        if (badge) {
