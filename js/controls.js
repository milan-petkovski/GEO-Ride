...
export function pollGamepad() {
    ...
    const rtVal = typeof activePad.buttons[7]?.value === 'number' ? activePad.buttons[7].value : (activePad.buttons[7]?.pressed ? 1 : 0);
    ...
    const ltVal = typeof activePad.buttons[6]?.value === 'number' ? activePad.buttons[6].value : (activePad.buttons[6]?.pressed ? 1 : 0);
